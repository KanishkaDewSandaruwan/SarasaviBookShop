          ...
          <div class="row justify-content-between pb-5 pt-8">
            <div class="col-12 col-lg-auto mb-5 mb-lg-0"><a class="d-flex align-items-center fw-semi-bold fs-3" href="#"> 
              <!-- <img class="me-3" src="assets/img/gallery/logo.png" alt="" /> -->
                <div class="text-white font-base">Sarasavi Bookshop</div>
              </a><p><?php echo $res['about_desc']; ?></p>
            </div>
            
          </div>
          <div class="row flex-center">
            <div class="col-auto mb-2">
              <p class="mb-0 fs--1 my-2 text-center">Sarasavi Bookshop</a> &copy; <script>document.write(new Date().getFullYear())</script>. All Right Reserved. 
              </p>
            </div>
            <div class="col-auto my-4">
              <ul class="list-unstyled list-inline mb-0">

                <li class="list-inline-item me-3"><a style="color: white;" href="<?php echo $res['link_twiiter']; ?>">
                ...
                <li class="list-inline-item me-3"><a class="text-decoration-none" style="color: white;" href="<?php echo $res['link_facebook']; ?>">
                ...
                <li class="list-inline-item me-3"><a style="color: white;" href="<?php echo $res['link_instragram']; ?>">
